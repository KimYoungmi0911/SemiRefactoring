                ...
                <div class="row  pr0 padding-top-40 properties-page">
                    <div class="col-md-12 padding-bottom-40 large-search"> 
                        <div class="search-form wow pulse" style="width:195%;">
                            <form action="/semi/psearch" class=" form-inline" style="margin-left : 20%;">
                                <div class="col-md-12">
                    ...
                    <div class="col-md-12 clear " style="margin-left : 50px;"> 
                            ...
                            <div class="col-sm-6 col-md-3 p0">
                                <div class="box-two proerty-item">
                                    <div class="item-thumb">
                                        <a href="/semi/pdetail.bd?pname=<%= p.getP_name() %>"><img src="<%=p.getP_main_image().split(",")[0]%>" style="max-height: 248px; max-width: 304px;"></a>
                                    </div>
